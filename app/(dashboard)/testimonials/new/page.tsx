...
export default function NewTestimonialPage() {
  ...
  return (
    <DashboardFormShell backHref="/testimonials" title="Add Testimonial">
      <form onSubmit={handleSubmit} className="glass-effect border-border rounded-3xl p-8 md:p-10 space-y-6">
        ...
        <div className="flex justify-end gap-4 pt-4 border-t border-border">
          ...
          <Button type="submit" variant="primary" disabled={isSubmitting}>{isSubmitting ? "Saving..." : "Save Testimonial"}</Button>
        </div>
      </form>
    </DashboardFormShell>
  );
